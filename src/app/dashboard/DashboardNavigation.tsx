      ...
      >
        ...
        <div style={{ padding: '1.5rem', borderTop: '1px solid rgba(255,255,255,0.05)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            ...
            <div>
              <p style={{ fontWeight: 'bold', fontSize: '0.9rem' }}>{user.name} <span style={{ fontWeight: 'normal', color: 'var(--text-secondary)', fontSize: '0.8rem' }}>@{user.username}</span></p>
              <p style={{ fontSize: '0.8rem', color: 'var(--text-secondary)' }}>{user.plan} User</p>
            </div>
          </div>
        </div>
      </aside>
